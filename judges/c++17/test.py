...
class JudgeTest(unittest.TestCase):
    ...
    def fetch_problem_and_test(self, problem_root, language, solution_status):
        ...
        args['submission_file_url'] = "{0}/solutions/{1}/{2}/solution.cpp".format(problem_root, language, solution_status)
    ...
    def test_helloworld_ac(self):
        self.fetch_problem_and_test("https://paullee-cdn.nyc3.digitaloceanspaces.com/pnoj/problems/helloworld/", "c++17", "ac")

    def test_aplusb_ac(self):
        self.fetch_problem_and_test("https://paullee-cdn.nyc3.digitaloceanspaces.com/pnoj/problems/aplusb/", "c++17", "ac")

    def test_aplusb_wa(self):
        self.fetch_problem_and_test("https://paullee-cdn.nyc3.digitaloceanspaces.com/pnoj/problems/aplusb/", "c++17", "wa")

    def test_aplusb_tle(self):
        self.fetch_problem_and_test("https://paullee-cdn.nyc3.digitaloceanspaces.com/pnoj/problems/aplusb/", "c++17", "tle")

    def test_aplusb_ir(self):
        self.fetch_problem_and_test("https://paullee-cdn.nyc3.digitaloceanspaces.com/pnoj/problems/aplusb/", "c++17", "ir")
